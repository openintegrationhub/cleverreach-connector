...
//     expect(Receivers.result).to.have.length(2);
//     expect(Receivers.result[0].firstName).to.equal('John');
//     expect(Receivers.result[0].lastName).to.equal('Doe');
//     expect(Receivers.result[0].photo).to.equal('www.photo.com/john');
//     expect(Receivers.result[0].addresses[0].street).to.equal('Main Str');
//     expect(Receivers.result[0].addresses[0].streetNumber).to.equal('688');
//     expect(Receivers.result[0].addresses[0].city).to.equal('New York City');
//     expect(Receivers.result[0].contactData[0].value).to.equal('johny@mail.com');
//     expect(Receivers.result[0].contactData[2].type).to.equal('linkedIn');
//   });
//
...
//     expect(organizations.result[1].relations[0].partner.kind).to.equal('Receiver');
...
//     expect(organizations.result[1].relations[0].type).to.equal('OrganizationToReceiver');
//   });
//
...
//   });
//
//   it('should search for Receivers', async () => {
...
//     expect(Receivers.result[0].firstName).to.equal('John');
//     expect(Receivers.result[0].lastName).to.equal('Doe');
//     expect(Receivers.result[0].contactData).to.have.lengthOf(9);
//     expect(Receivers.result[0].addresses).to.have.lengthOf(2);
//     expect(Receivers.result[1].firstName).to.equal('John');
//     expect(Receivers.result[1].lastName).to.equal('NotDoe');
//     expect(Receivers.result[1].contactData).to.have.lengthOf(2);
//     expect(Receivers.result[1].addresses).to.have.lengthOf(1);
//   });
//
...
//     expect(Receivers.result[0].logo).to.equal('logo.jpg');
//   });
// });
