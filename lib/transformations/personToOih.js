...
module.exports.personToOih = (msg) => {
  ...
  let lastname = '';
  if (msg.data.attributes && msg.data.attributes.lastname) {
    // eslint-disable-next-line prefer-destructuring
    lastname = msg.data.attributes.lastname;
  } else if (msg.data.attributes && msg.data.attributes.name) {
    lastname = msg.data.attributes.name;
  } else if (msg.data.attributes && msg.data.attributes.nachname) {
